      ...
      <nav className="flex-row gap-20 hidden md:flex">
        ...
        <ul className="flex flex-row gap-10">
          ...
          <li className="hover:text-primary flex gap-2 hover:underline duration-100">
            <a className={`text-sm  text-black dark:text-white flex gap-2 hover:text-primary font-medium transition-all duration-100`} target="https://github.com/Cancastico" href="#">
              <GitHubLogoIcon />
              Github
            </a>
          </li>
