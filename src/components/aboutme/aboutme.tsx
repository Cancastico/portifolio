  ...
  return (
    <div className=" flex flex-col min-h-[10rem]" >
      <section className="w-full min-h-[10rem] relative">
        ...
        />
        {/* CONTENT */}
        <div className="flex flex-row w-full bg-[#010021]/70 dark:bg-[#15282E]/90">
          <div className=" flex flex-col gap-10 py-12 h-full w-[60%] px-[2rem] ">
            <div className="px-[1rem] md:px-[5rem] w-full">
              ...
              <p className="text-white w-full text-lg pl-3 leading-relaxed" >
          ...
          <iframe  className=" flex flex-col gap-10 py-12 w-[30%]" src="https://lottie.host/embed/da011d71-994a-4d22-bff8-1dbe97ff2515/BsUPtgrVDv.json"></iframe>
