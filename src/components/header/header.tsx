...
export default function Header() {
  ...
  return (
    <header className="flex flex-col items-center bg-background-primary dark:bg-background-dark pb-[2rem] min-h-[45rem] justify-center md:px-[8rem] xxl:px-[16rem] pt-16 xl:pt-0">
